function [X1,X2] = EDMD_curl(X,r)
% Modication of EDMD to model two observables together, using
...
for n = 1:N
    ...
    for i = 1:M
        ...
        for j = 1:M
            ...
            DD(idx1,idx2) = DD(idx1,idx2)+(1/sigma^2)*exp(-c/2)*((1-c)*eye(2)+(x-y)*(x-y)'/(sigma^2));
        end
    end
end
DD = DD/N;
