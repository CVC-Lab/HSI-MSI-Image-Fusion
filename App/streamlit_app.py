...
def page2():
    ...
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/denoise before after.png", caption="(left) Original Indian Pines image with 200 bands (2nd band), (right) SRI generated after denoising the original image (2nd band)")
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/denoise plot.png", caption="SNR vs time of input Indian Pines image during the denoising process")

    st.markdown("### Mis-registration = 0")
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/misreg0 hsi.png", caption="Selected bands (every 8th band, starting from 2nd band) of the generated HSI")
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/MSI bands.png", caption="Generated MSI of 6 bands")
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/misreg0 sri.png", caption="(left) Original SRI (ground truth) (2nd band), (right) SRI generated by fusing MSI and HSI using BGLRF (2nd band)")

    st.markdown("### Mis-registration = 2")
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/HSI selected bands.png", caption="Selected bands (every 8th band, starting from 2nd band) of the generated HSI")
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/MSI bands.png", caption="Generated MSI of 6 bands")
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/SRI original vs fused.png", caption="(left) Original SRI (ground truth) (2nd band), (right) SRI generated by fusing MSI and HSI using BGLRF (2nd band)")

    st.markdown("### Mis-registration = 4")
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/misreg4 hsi.png", caption="Selected bands (every 8th band, starting from 2nd band) of the generated HSI")
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/MSI bands.png", caption="Generated MSI of 6 bands")
    st.image("/Users/pronomabanerjee/Dropbox/My Mac (Pronoma’s MacBook Air)/Desktop/UT Austin/HSI-MSI-Image-Fusion/App/Images/misreg4 sri.png", caption="(left) Original SRI (ground truth) (2nd band), (right) SRI generated by fusing MSI and HSI using BGLRF (2nd band)")
